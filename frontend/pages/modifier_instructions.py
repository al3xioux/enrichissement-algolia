...
from backend.SupaBase.main import get_all_instructions_categories_lvl0, update_instruction_category_lvl0
...
if categorie:
    with st.form("edit_instruction_form"):
        ...
        nouvelle_instruction_juge = st.text_area("Instruction Juge", value=categorie.get('Instruction_juge', ''), height=300)
